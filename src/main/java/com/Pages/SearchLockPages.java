...
public class SearchLockPages extends BaseDriver{
	...
	public final CommonMethods lockIconNotification = new CommonMethods("Lock Icon Notification", By.id("slttip"));
	...
	public WebElement lockIconNotificationElement()
	   {
		 WebElement var = null;
		try
		{
	    		if(BaseDriver.extensionName.contains("v1.0.5"))
	    		{
	    			 var = driver.findElement(By.id("sl-tooltip"));
	    		}
	    		else 
	    		{
	    			 var = driver.findElement(By.id("slttip"));
	    		}
		}
		catch(Exception e)
		{
    		System.err.println("FAILED: Element SearchLock Icon is not displayed!");
			Assert.fail();
		}
